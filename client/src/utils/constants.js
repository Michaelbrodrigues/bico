...
//export const GET_PRE_TRANSACTION_MESSAGES = `${HOST}/messages/get-pre-transaction`;
//export const ADD_PRE_TRANSACTION_MESSAGE = `${HOST}/messages/add-pre-transaction`;
export const ADD_PRE_TRANSACTION_MESSAGE = `${MESSAGES_ROUTES}/add-pre-transaction`; // New route for pre-transaction messages
export const GET_PRE_TRANSACTION_MESSAGES = `${MESSAGES_ROUTES}/get-pre-transaction`; // New route for pre-transaction messages

//export const GET_SELLER_DASHBOARD_DATA = `${HOST}/dashboard/seller-data`;
